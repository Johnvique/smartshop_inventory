...
<head>
  ...
  <title>Smartshop-Inventory</title>
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseCategory" class="collapse" aria-labelledby="headingCategory" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="{{url('dashboard/category')}}">Add Category</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
      <a class="nav-link" href="{{url('dashboard/purchases')}}">
      ...
      <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow">
            ...
            <img class="img-profile rounded-circle" src="{{asset('img/jvic.jpg')}}">
            </a>
      ...
      <div class="container my-auto">
        <div class="copyright text-center my-auto">
          <p>Copyright &copy; <script>document.write(new Date().getFullYear());</script>| 
            ...
            Smartshop-Inventory</a> | All rights reserved.</p>
        </div>
      </div>
    </footer>
    <!-- End of Footer -->
